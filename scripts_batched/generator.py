...
class Generator:
    ...
    def rerank(self, sorted_vals, indices, dist_score):
        ...
        elif (self.SCORE_MODE != 'dot' and self.TARGET == 'far') or (
                self.SCORE_MODE == 'dot' and self.TARGET == 'close'):
    ...
    def generate_one(self, prompts, p):
    ...
    def beam_search(self, prompts, tokens_to_generate=25):
        for i in range(tokens_to_generate):
            prompts = self.generate_one(prompts)
        return prompts
